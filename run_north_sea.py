...
# plt.plot(
#     [melt_fraction_fit['T_path'], s.PT.iloc[0]['T']], 
#     [melt_fraction_fit['P_path'], s.PT.iloc[0]['P']])
# plt.scatter(s.PT.iloc[0]['T'], s.PT.iloc[0]['P'], marker="*")
# plt.scatter(melt_fraction_fit['T_path'], melt_fraction_fit['P_path'])
...
#     plt.plot(
#         [s.individual_melt_fractions.iloc[i]['T_path'], s.PT.iloc[i]['T']], 
#         [s.individual_melt_fractions.iloc[i]['P_path'], s.PT.iloc[i]['P']])
#     plt.scatter(s.PT.iloc[i]['T'], s.PT.iloc[i]['P'], marker="*")
#     plt.scatter(s.individual_melt_fractions.iloc[i]['T_path'], s.individual_melt_fractions.iloc[i]['P_path'])
# plt.xlabel(r"Temperature [$^\circ$C]")
# plt.ylabel("Pressure [GPa]")
# plt.gca().invert_yaxis()
# plt.show()
