...
#
# Here we will demonstrate how one could set up a Monte Carlo analysis of
# uncertainties using meltPT. In doing so we will recreate the analysis shown
# in Figure 2 of McNab & Ball (in rev., Volcanica).
#------------------------------------------------------------------------------
...
s = Suite("../Data/PF16_UT09DV04.csv", src_FeIII_totFe=src_FeIII_totFe.val, src_Fo=src_Fo.val)
