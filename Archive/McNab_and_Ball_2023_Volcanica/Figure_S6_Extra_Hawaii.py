...
# ---- Figure S6
#
# Recreate elements of Figure S6 from McNab & Ball (2023).
# Comment/uncomment lines 34-42/44-47 to change input parameter value preferences.
# Edit lines 55-58 to change phase.
# Comment/uncomment lines 83/84 to remove samples > 3 GPa from melt-path fitting (all samples will plot).
...
# calculate Tp
# filter = lambda df: df['P'] < 3.
filter = None
s.find_suite_potential_temperature(mantle, find_bounds=True, filters=(filter,))
