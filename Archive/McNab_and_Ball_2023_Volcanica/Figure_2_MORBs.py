...
# ---- Figure 2
# 
# Recreate elements of Figure 2 from McNab & Ball (2023).
# See also Tutorial 2 for more details and a version that works with the
...
s = Suite(
    "ridge_in.csv", src_FeIII_totFe=0.14, src_Fo=0.9, Ce_to_H2O=200., 
    min_MgO=8.5)
