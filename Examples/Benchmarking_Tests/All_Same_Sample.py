...
#     (s.PT['P'], s.PT['T']))
# s.compute_pressure(T=1508.)
# print("Plank & Forsyth (2016) assume T: P = %.2f GPa, T = %i oC." % 
#     (s.PT['P'], s.PT['T']))
...
# print("Beattie (1993) assume P:         P = %.2f GPa, T = %i oC." % 
#     (s2.PT['P'], s2.PT['T']))
...
#     (s3.PT['P'], s3.PT['T']))
# s3.compute_pressure(method="L09", T=1493.)
# print("Lee et al (2009) assume T:       P = %.2f GPa, T = %i oC." % 
#     (s3.PT['P'], s3.PT['T']))
...
# s4.compute_temperature(method="TGK12_SPL", P=2.39)
# print("Till et al (2012) SPL assume P:  P = %.2f GPa, T = %i oC." % 
#     (s4.PT['P'], round(s4.PT['T'])))
...
# s5.compute_temperature(method="TGK12_PLG", P=2.83)
# print("Till et al (2012) PLG assume P:  P = %.2f GPa, T = %i oC." % 
#     (s5.PT['P'], round(s5.PT['T'])))
...
#     (s6.PT['P'], s6.PT['T']))
# s6.compute_temperature(method="G13", P=2.48)
# print("Grove et al (2013) assume P:     P = %.2f GPa, T = %i oC." % 
#     (s6.PT['P'], s6.PT['T']))
...
#     (s7.PT['P'], s7.PT['T']))
# s7.compute_temperature(method="BK21", P=2.62)
# print("Krein et al (2021) assume P:     P = %.2f GPa, T = %i oC." % 
#     (s7.PT['P'], s7.PT['T']))
...
# print("Herzberg & Asimow (2015) assume P:P = %.2f GPa, T = %i oC." % 
...
#     (s9.PT['P'], s9.PT['T']))
# s9.compute_pressure(method="P08", T=1495.)
# print("Putirka et al (2008) assume T:   P = %.2f GPa, T = %i oC." % 
#     (s9.PT['P'], s9.PT['T']))
...
print("Sun & Dasgupta (2020):           P = %.2f GPa, T = %i oC." % 
    (s9.PT['P'], s9.PT['T']))
s9.compute_temperature(method="SD20", P=2.74)
print("Sun & Dasgupta (2020) assume P:  P = %.2f GPa, T = %i oC." % 
    (s9.PT['P'], s9.PT['T']))
s9.find_individual_potential_temperatures(mantle)
print("Best-fitting melting model:      Tp = %i oC, F = %.2f %%." % 
    (s9.individual_potential_temperatures['Tp'], 
